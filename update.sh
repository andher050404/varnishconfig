...
cp ${VARNISH_CLIENT_LOG} ${VARNISH_CLIENT_LOG_ROTATE}$(date '+_%d_%m_%Y') && > ${VARNISH_CLIENT_LOG}
cp ${VARNISH_BACKEND_LOG} ${VARNISH_BACKEND_LOG_ROTATE}$(date '+_%d_%m_%Y') && > ${VARNISH_BACKEND_LOG}
